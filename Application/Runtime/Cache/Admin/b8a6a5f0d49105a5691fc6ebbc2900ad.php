                                ...
                                <tr>
                                    ...
                                    <td >                         		
                                        <select class="form-control" name="auto_confirm_date" id="distribut_date">
                                                <?php $__FOR_START_1330046667__=1;$__FOR_END_1330046667__=31;for($i=$__FOR_START_1330046667__;$i < $__FOR_END_1330046667__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($config[auto_confirm_date] == $i): ?>selected="selected"<?php endif; ?>><?php echo ($i); ?>天</option><?php } ?>
                                        </select>                                      
                                    </td>
                                </tr> 
                                <tr>
