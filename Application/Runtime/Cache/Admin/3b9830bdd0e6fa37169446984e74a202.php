                            ...
                            <div class="tab-pane active" id="tab_tongyong">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-sm-8">
                                            <input type="text" class="form-control" msg = "阿里大鱼[appkey]" name="sms_appkey" value="<?php echo ($config["sms_appkey"]); ?>" >
                                    ...
                                    <tr>
                                        ...
                                        <td >
                                            <input type="text" class="form-control" msg = "阿里大鱼[secretKey]" name="sms_secretKey" value="<?php echo ($config["sms_secretKey"]); ?>" >
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>公司名/品牌名/产品名：</td>
                                        <td >
                                            <input type="text" class="form-control" msg = "公司名/品牌名/产品名" name="sms_product" value="<?php echo ($config["sms_product"]); ?>" >
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>短信模板ID：</td>
                                        <td >
                                            <input type="text" class="form-control" msg = "短信模板ID" name="sms_templateCode" value="<?php echo ($config["sms_templateCode"]); ?>" placeholder="例如SMS_12885853" >
                                        </td>
                                    </tr>                                    
                                    <tr>
                                        <td>注册启用短信：</td>
                                        <td>
                                            <input id="turnOn" type="radio" class="" name="regis_sms_enable" <?php if($config['regis_sms_enable'] == 1): ?>checked<?php endif; ?> value="1" >是
